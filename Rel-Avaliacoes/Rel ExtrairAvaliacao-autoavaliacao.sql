...
INNER JOIN TB_OBJAPRENDIZAGEM_AUTOAVALIACAO OAVA3 ON OAVA3.CD_OBJETOAPRENDIZAGEM=O.CD_OBJETOAPRENDIZAGEM AND O.ID_TIPO LIKE 'AUTO_AVALIACAO'
...
-- WHERE O.CD_OBJETOAPRENDIZAGEM = 99 -- 192
